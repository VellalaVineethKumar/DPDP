...
PRIVACY_LAWS = {
    ...
    "pdpp_oman": {
        ...
        "country": "Oman",
        "website": "https://mtc.gov.om/itaportal/Data/SiteImgGallery/2024102711584976/Personal%20Data%20Protection%20Policy.pdf",
        "prompt_template": """
...
def find_privacy_policy_url(organization_name: str, num_results: int = 5) -> Optional[str]:
    """Find privacy policy URL using Google search."""
    logger.info(f"Searching privacy policy for organization: {organization_name}")
    query = f"{organization_name} privacy policy"
    try:
